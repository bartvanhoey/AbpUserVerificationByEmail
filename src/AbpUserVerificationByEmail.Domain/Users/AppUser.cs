...
namespace AbpUserVerificationByEmail.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpUserVerificationByEmailDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpUserVerificationByEmailEfCoreEntityExtensionMappings to extend the IdentityUser entity
